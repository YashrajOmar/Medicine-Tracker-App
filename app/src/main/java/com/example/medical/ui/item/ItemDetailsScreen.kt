...
fun ItemDetails(
    ...
    Card(
        ...
        Column(
            ...
            ItemDetailsRow(
                labelResID = R.string.doctor ,
                itemDetail = item.doctor,
                modifier = Modifier.padding(
                    horizontal = dimensionResource(
                        id = R.dimen
                            .padding_medium
            ...
            ItemDetailsRow(
                labelResID = R.string.medicine,
                itemDetail = item.medicine,
                modifier = Modifier.padding(
                    horizontal = dimensionResource(
                        id = R.dimen
                            .padding_medium
            ...
            ItemDetailsRow(
                labelResID = R.string.test,
                itemDetail = item.test,
                modifier = Modifier.padding(
                    horizontal = dimensionResource(
                        id = R.dimen
                            .padding_medium
            ...
            ItemDetailsRow(
                labelResID = R.string.editor,
                itemDetail = item.editor,
                modifier = Modifier.padding(
                    horizontal = dimensionResource(
                        id = R.dimen
                            .padding_medium
...
fun ItemDetailsScreenPreview() {
    MedicalTheme {
        ItemDetailsBody(ItemDetailsUiState(
             itemDetails = ItemDetails(1, "Ram", "Dettol", "Blood","skm","17/23/2023")
        ), onSaveItem = {}, onDelete = {})
    }
}