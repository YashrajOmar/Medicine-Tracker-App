...
fun ItemInputForm(
    ...
    Column(
        ...
        OutlinedTextField(
            value = itemDetails.doctor,
            onValueChange = { onValueChange(itemDetails.copy(doctor = it)) },
        ...
        OutlinedTextField(
            value = itemDetails.medicine,
            onValueChange = { onValueChange(itemDetails.copy(medicine = it)) },
        ...
        OutlinedTextField(
            value = itemDetails.test,
            onValueChange = { onValueChange(itemDetails.copy(test = it)) },
        ...
        OutlinedTextField(
            value = itemDetails.editor,
            onValueChange = { onValueChange(itemDetails.copy(editor = it)) },
...
private fun ItemEntryScreenPreview() {
    MedicalTheme  {
        ItemEntryBody(itemUiState = ItemUiState(
            ItemDetails(
                date = "21/12/2024", doctor = "Ali", editor = "Lucky", medicine = "paracetamol", test = "Blood"
            )
